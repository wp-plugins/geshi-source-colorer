...
class render {
    ...
    static function optionfields()
    {
        ...
        add_settings_field("visualeditor",      __("enable / disable HTML decode (on visual editor using)", "fpx_geshisourcecolorer")." <em>[visualeditor]</em>",       get_class()."::render_visualeditor",      "fpx_geshisourcecolorer_optionmain",      "fpx_geshisourcecolorer_option");
